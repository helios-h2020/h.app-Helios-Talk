...
public abstract class HeliosTalkAdapter<T, V extends ViewHolder>
    ...
    public HeliosTalkAdapter(Context ctx, Class<T> c) {
        this.ctx = ctx;
        this.items = new SortedList<>(c, new SortedList.Callback<T>() {
            @Override
            public int compare(T item1, T item2) {
                return HeliosTalkAdapter.this.compare(item1, item2);
            }
            ...
            public boolean areContentsTheSame(T item1, T item2) {
                return HeliosTalkAdapter.this.areContentsTheSame(item1, item2);
            }

            @Override
            public boolean areItemsTheSame(T item1, T item2) {
                return HeliosTalkAdapter.this.areItemsTheSame(item1, item2);
            }
        });
    }
