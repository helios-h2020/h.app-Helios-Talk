...
public class LockManagerImpl implements LockManager, Service, EventListener {
	...
	LockManagerImpl(Application app, SettingsManager settingsManager,
		...
		Intent i =
				new Intent(ACTION_LOCK, null, appContext, HeliosTalkService.class);
	...
	public void checkIfLockable() {
		...
		boolean newValue = UiUtils.hasScreenLock(appContext) && lockableSetting;
	...
	public boolean isLocked() {
		if (locked && !UiUtils.hasScreenLock(appContext)) {
