...
public class HeliosTalkService extends Service {
	...
	public static String EXTRA_START_RESULT =
			"eu.h2020.helios.talk.START_RESULT";
	public static String EXTRA_NOTIFICATION_ID =
			"eu.h2020.helios.talk.FAILURE_NOTIFICATION_ID";
	public static String EXTRA_STARTUP_FAILED =
			"eu.h2020.helios.talk.STARTUP_FAILED";

	private static final Logger LOG =
			Logger.getLogger(HeliosTalkService.class.getName());

	private final AtomicBoolean created = new AtomicBoolean(false);
	private final Binder binder = new HeliosTalkBinder();

	@Nullable
	private BroadcastReceiver receiver = null;
	private HeliosTalkApplication app;
	...
	public void onCreate() {
		...
		app = (HeliosTalkApplication) getApplication();
		...
		if (SDK_INT >= 26) {
			...
			NotificationChannel ongoingChannel = new NotificationChannel(
					AndroidNotificationManager.ONGOING_CHANNEL_ID,
			...
			NotificationChannel failureChannel = new NotificationChannel(
					AndroidNotificationManager.FAILURE_CHANNEL_ID,
		...
		startForeground(AndroidNotificationManager.ONGOING_NOTIFICATION_ID,
	...
	private void showStartupFailureNotification(StartResult result) {
		androidExecutor.runOnUiThread(() -> {
			...
			Intent i = new Intent(HeliosTalkService.this,
					StartupFailureActivity.class);
			i.setFlags(FLAG_ACTIVITY_NEW_TASK);
			i.putExtra(EXTRA_START_RESULT, result);
			i.putExtra(EXTRA_NOTIFICATION_ID,
					AndroidNotificationManager.FAILURE_NOTIFICATION_ID);
			b.setContentIntent(PendingIntent.getActivity(HeliosTalkService.this,
					0, i, FLAG_UPDATE_CURRENT));
			Object o = getSystemService(NOTIFICATION_SERVICE);
			NotificationManager nm = (NotificationManager) o;
			nm.notify(AndroidNotificationManager.FAILURE_NOTIFICATION_ID,
					b.build());
			// Bring the dashboard to the front to clear the back stack
			i = new Intent(HeliosTalkService.this, ENTRY_ACTIVITY);
	...
	public class HeliosTalkBinder extends Binder {

		/**
		 * Returns the bound service.
		 */
		public HeliosTalkService getService() {
			return HeliosTalkService.this;
		}
	}

	public static class HeliosServiceConnection implements ServiceConnection {
