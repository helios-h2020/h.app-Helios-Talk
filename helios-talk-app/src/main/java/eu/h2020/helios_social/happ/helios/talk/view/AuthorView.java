...
public class AuthorView extends ConstraintLayout {
    ...
    public AuthorView(Context context, @Nullable AttributeSet attrs) {
        ...
        verifiedIcon = findViewById(R.id.verified);
    ...
    public void setAuthor(PeerInfo peerInfo) {
        if (peerInfo.getFunnyName() != null) {
            authorName.setText(peerInfo.getFunnyName());
    ...
    public void setAuthorVerified(boolean isVerified) {
        if (isVerified) verifiedIcon.setVisibility(VISIBLE);
        else verifiedIcon.setVisibility(GONE);
    }
