    ...
    private void onHeliosLinkLoaded(String link) {
        ...
        shareButton.setOnClickListener(view ->
                                               IntentBuilder.from(requireActivity())
                                                       .setText("Let's get connected to helios. TALK! Please add me to your contacts by opening the following link with helios. TALK https://helios-social.com/" + link.replace("helios://", "") + " or by pasting my helios link (" + link + ") directly to the app")
                                                       .setType("text/plain")
                                                       .startChooser());
